...
//+kubebuilder:rbac:groups=batch.operator.jubril.me,resources=servicewatchers,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=batch.operator.jubril.me,resources=servicewatchers/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=batch.operator.jubril.me,resources=servicewatchers/finalizers,verbs=update
